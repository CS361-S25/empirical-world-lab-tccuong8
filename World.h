...
class OrgWorld : public emp::World<emp::Ptr<Organism>>
{
...
public:
    OrgWorld(emp::Random &_random) : emp::World<emp::Ptr<Organism>>(_random), random(_random)
    {
    ...
    void Update()
    {
        emp::World<emp::Ptr<Organism>>::Update();
